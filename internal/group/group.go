...
func (s *Service) RegisterGroup(_ context.Context, groupID string) error {
...
func (s *Service) UnregisterGroup(_ context.Context, groupID string) error {
	s.memMap.Delete(groupID)

	return nil
}

func (s *Service) GetListeners(_ context.Context, groupID string) (map[string]struct{}, error) {
...
func (s *Service) GetGroups(_ context.Context) ([]string, error) {
...
func (s *Service) RegisterListener(_ context.Context, groupID string, clientID string) error {
	val, ok := s.memMap.Load(groupID)
	if !ok {
...
func (s *Service) UnregisterListener(_ context.Context, groupID string, clientID string) error {
	val, ok := s.memMap.Load(groupID)
	if !ok {
...
func (s *Service) FindGroup(_ context.Context, groupID string) (map[string]struct{}, error) {
	val, ok := s.memMap.Load(groupID)
	if !ok {
		return nil, fmt.Errorf("GetListeners: listeners not found")
	}
